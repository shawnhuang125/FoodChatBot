...
- **SQL Server + Main Server(API)**
    ...
    ```
- **Map-API Service**
    -  [Map-API Service說明文件下載連結20250310](https://1drv.ms/p/c/2246da9308bf8a0b/ET37_BkFFsRLsb-BHIPy7QQB9ZdrLuaBUBnml9bjtL-oQw?e=i4WvHO)
...
- **手機APP**
    ...
    手機APP:flutter設計(林聖峰)(已完成)
    手機APP:kotlin設計(林聖峰)(已完成)
    手機APP:swift設計(林聖峰)(已完成)
    手機APP:部屬(林聖峰)
    手機APP:API整合開發測試(林聖峰)
    手機APP:整合口譯功能(林聖峰)
    ```

...
| 前端負責人(APP) | APP介面設計、APP 前端邏輯實作、前端元件架構設計、前端與 API 串接整合、確保前端功能與體驗流暢 |
| 後端負責人 (API) | API 設計與實作、資料庫設計與管理、資料庫配置與處理、API 安全性與權限控制、後端邏輯優化 |
| 後端負責人 (FoodChatBot) | FoodChatBot 功能設計與實作、FoodChatBot 專屬模組開發、API 對接與整合、聊天功能驗證 |
| 後端負責人 (STT&TTS) | 語音功能服務 (STT) 設計與實作、STT 模組整合與優化、API 對接 STT、語音轉文字服務驗證與測試 | 
